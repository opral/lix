...
pub(crate) use actor::{
    ...
    PluginActorDetachedSuccessor, PluginActorKey, PluginActorLease, PluginActorPendingPublication,
    PluginActorStagedCheckpoint, PluginActorStore, PluginActorStorePermit, PluginObservation,
    PluginRowAuthorities, PluginRowAuthorityRange,
};
