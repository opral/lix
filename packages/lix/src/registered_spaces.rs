...
pub const GC_REACHABILITY_DELTA_SPACE: StorageSpace = crate::gc::GC_REACHABILITY_DELTA_SPACE;
pub const GC_REACHABILITY_QUEUE_SPACE: StorageSpace = crate::gc::GC_REACHABILITY_QUEUE_SPACE;
