...
pub(crate) use storage::{
    ...
    accelerator_root_set_digest, canonical_accelerator_source_identity,
    certify_rebuildable_accelerator_publication,
    stage_addressable_commit_deltas_with_selected_source,
    stage_certified_commit_state_manifest_with_accelerator_handle,
    stage_certified_commit_state_manifest_with_handle, stage_change_locators,
    stage_commit_deltas_for_commit_state, stage_commit_state_manifest_with_accelerator_handle,
