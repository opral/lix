...
mod tests {
        ...
        storage_codec::encode(
            ...
            &vec![
                StoredCurrentStateDataRow {
                    ...
                    snapshot: LegacyJsonValue::from_json(r#"{"row":1}"#),
                    metadata: LegacyJsonValue::None,
                },
                StoredCurrentStateDataRow {
                    encoded_key: b"beta".to_vec(),
                    encoded_value: encoded_value(2, false),
                    snapshot: LegacyJsonValue::from_json(r#"{"row":2}"#),
                    metadata: LegacyJsonValue::from_json(r#"{"source":"v68"}"#),
                },
            ],
        )
    ...
    fn decodes_frozen_raw_lxcsp01_into_owned_neutral_rows() {
        ...
        assert_eq!(rows[0].snapshot, LegacyJsonValue::from_json(r#"{"row":1}"#));
        assert_eq!(
            rows[1].metadata,
    ...
    fn decodes_frozen_compressed_lxcspz1_and_rejects_invalid_rows() {
        ...
        let tombstone = vec![StoredCurrentStateDataRow {
            ...
            snapshot: LegacyJsonValue::from_json("{}"),
            metadata: LegacyJsonValue::None,
        }];
