    ...
    async fn authority_gc_retains_tombstone_only_checkpoint_alias_source() {
        ...
        let commits = [
            CommitRecord {
                ...
                linear_segment_base_commit_id: source_commit,
            ...
            CommitRecord {
                ...
                generation: 0,
                parent_commit_ids: Vec::new(),
                linear_segment_base_commit_id: alias_commit,
                linear_segment_depth: 0,
            ...
            CommitRecord {
                ...
                generation: 0,
                parent_commit_ids: Vec::new(),
                linear_segment_base_commit_id: authority_commit,
                linear_segment_depth: 0,
            ...
            CommitRecord {
                ...
                linear_segment_base_commit_id: live_head,
                linear_segment_depth: 0,
    ...
    async fn authority_gc_retains_immutable_packed_owner_and_sweeps_dead_standalone_fact() {
        ...
        let commits = vec![
            CommitRecord {
                ...
                generation: 0,
                parent_commit_ids: Vec::new(),
                linear_segment_base_commit_id: live_parent,
                linear_segment_depth: 0,
            ...
            CommitRecord {
                ...
                generation: 0,
                parent_commit_ids: Vec::new(),
                linear_segment_base_commit_id: dead_commit,
                linear_segment_depth: 0,
