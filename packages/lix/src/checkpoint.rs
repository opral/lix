...
use crate::LixError;
use crate::changelog::{ChangeRecordProjection, CommitId, CommitRecord};
...
pub(crate) type CheckpointCommitRecords = HashMap<CommitId, CommitRecord>;
    ...
    S: StorageAdapterRead,
{
    ...
    loop {
        ...
        for record in batch.entries {
            records.insert(record.commit_id, record);
        }
