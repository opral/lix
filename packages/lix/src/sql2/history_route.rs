...
pub(crate) struct HistoryEntry {
    ...
    /// Authenticated Schema-v1 body for typed entity-history projection.
    /// This is populated only for the native entity route; JSON payload
    ...
    S: StorageAdapterRead + Clone + Send + Sync + 'static,
{
    ...
    for as_of_commit_id in as_of_commit_ids {
        ...
        if metadata_projection.native_entity_rows {
