...
# Dormant negative compiler gate. Run only after a future candidate has
# produced a Lix rlib; a successful old-reader/space import is a hard fail.
...
printf 'ForkTree tracked-state reader compile-fail probes\n'
