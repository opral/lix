...
- Optimized warnings-denied binary SHA-256:
  `39cced80c059413a37ca364a5fbc3cf407057fa9ee354ff2f70480bf637561f9`.
- Source size: 2,405 lines / 79,868 bytes.
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| Memory normal F=32 | 1K | 1,032 | 100 | 4.018 ms | <10 ms tick | 1.120 MB | 3,128 KiB | 2,232 | 89,744 B | 82,784 B | 2,993,430 B / 1,218 | 2,432,384 B / 93 | 100 / 5 batches | 118,615 B |
| Memory fanout=4097, shared 8-byte prefix | 1K | 5,097 | 100 | 43.994 ms | 40 ms | 10.425 MB | 4,732 KiB | 5,341 | 195,794 B | 185,208 B | 69,598,172 B / 7,627 | 64,537,710 B / 2,418 | 100 / 21 | 447,880 B |
| Memory normal F=32 | 50K | 50,032 | 5,000 | 1.768 s | 1.760 s | 55.650 MB | 27,508 KiB | 5,376 | 197,120 B | 2,310,672 B | 39,003,900 B / 56,539 | 11,820,062 B / 1,706 | 5,000 / 215 | 5,802,615 B |
| Memory adversarial shared 8-byte prefix | 50K | 50,032 | 5,000 | 1.792 s | 1.790 s | 62.909 MB | 27,508 KiB | 5,376 | 197,120 B | 2,302,512 B | 39,113,004 B / 58,236 | 11,929,166 B / 3,403 | 5,000 / 215 | 5,802,615 B |
| File normal F=32, reopen every checkpoint | 1K | 1,032 | 100 | 42.766 ms | 40 ms | 19.940 MB | 3,808 KiB | 2,232 | 89,744 B | 82,784 B | 2,993,430 B / 1,218 | 2,432,384 B / 93 | 100 / 5 | 118,615 B settled; 3,557,322 B checkpoint writes |
| File fanout=4097, reopen every checkpoint | 1K | 5,097 | 100 | 268.179 ms | 260 ms | 313.874 MB | 6,872 KiB | 5,341 | 195,794 B | 185,208 B | 69,598,172 B / 7,627 | 64,537,710 B / 2,418 | 100 / 21 | 447,880 B settled; 50,232,637 B checkpoint writes |
...
maintenance disk   O(R + Q), Q = persisted queue frontier
executor memory    O(one pack + one page + one object), independent of totals
```

Fully consumed queue packs are retired as the traversal advances. Therefore
`Q` contains only the active frontier plus at most one partially consumed pack;
it does not retain traversal history.
...
Peak retained IDs grew only 2,232 -> 5,376 and stopped below the fixed 6K
ceiling; peak GC metadata grew only 89,744 -> 197,120 bytes. The 50K
