    ...
    session
        .execute(
            "INSERT INTO lix_registered_schema (value, lixcol_global, lixcol_untracked) \
             VALUES (\
             CAST('{\"x-lix-key\":\"range_note\",\"x-lix-primary-key\":[\"/id\"],\"x-lix-unique\":[[\"/ordinal\"]],\"type\":\"object\",\"properties\":{\"id\":{\"type\":\"string\"},\"ordinal\":{\"type\":\"integer\"},\"lane\":{\"type\":\"string\"},\"weight\":{\"type\":\"number\"}},\"required\":[\"id\",\"ordinal\",\"lane\",\"weight\"],\"additionalProperties\":false}' AS JSONB),\
             false,\
             false\
             )",
            &[],
...
async fn register_pushdown_note_schema(
    ...
    session
        .execute(
            "INSERT INTO lix_registered_schema (value, lixcol_global, lixcol_untracked) \
             VALUES (\
             CAST('{\"x-lix-key\":\"pushdown_note\",\"x-lix-primary-key\":[\"/id\"],\"type\":\"object\",\"properties\":{\"id\":{\"type\":\"string\"},\"kind\":{\"type\":\"string\"},\"title\":{\"type\":\"string\"},\"score\":{\"type\":\"number\"},\"optional\":{\"type\":[\"string\",\"null\"]}},\"required\":[\"id\",\"kind\",\"title\",\"score\"],\"additionalProperties\":false}' AS JSONB),\
             false,\
             false\
             )",
            &[],
