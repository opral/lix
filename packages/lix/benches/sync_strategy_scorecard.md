...
initial decision gates are zero correctness failures, no branch leakage or
duplicate canonical commits, fast-forward latency within 10% of the best
strategy, and catch-up bytes proportional to changed rows rather than total
repository size.
