...
const identity: AdmissionIdentity = {repositoryId, principalId: "00000000-0000-7000-8000-000000000003", protocolEpoch: 18, storageEpoch: 81};
...
test("metadata admission uses bounded GET and explicit credentials without SQL opening", async () => {
  ...
  expect(new Headers(request.init.headers).get("lix-sync-protocol-version")).toBe("18");
