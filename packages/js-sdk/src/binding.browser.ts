...
// Start loading the plugin runtime with the worker, and finish before a
// repository can be used offline. A static import blocks worker startup while
// JCO initializes, whereas dispatch-time loading races with the first edit.
...
export async function openLixBinding(
	...
	const { compileComponent } = await componentCompiler;
