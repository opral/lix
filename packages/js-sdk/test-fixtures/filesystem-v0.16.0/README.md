...
current-format markers. It installs the published bundled Markdown plugin and contains `/notes.md`,
...
`generate.mjs` there, and run `node generate.mjs ./repository`. After it closes,
