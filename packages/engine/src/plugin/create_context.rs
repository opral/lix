...
mod tests {
    ...
    fn plugin() -> PluginRegistryEntry {
        PluginRegistryEntry::new(PluginRegistryEntryInput {
            ...
            manifest_json: r#"{"key":"plugin_csv","runtime":"wasm-component","api_version":"4.0.0","materialization":"blob","match":{"path_glob":"*.csv"},"entry":"plugin.wasm","schemas":["schema/csv_row.json"]}"#.to_string(),
