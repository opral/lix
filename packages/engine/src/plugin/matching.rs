...
mod tests {
    ...
    fn prefers_specific_glob_over_catch_all() {
        ...
        let selected = select_best_glob_match("/docs/readme.md", &candidates, |c| c.glob)
    ...
    fn prefers_more_specific_glob_by_score() {
        ...
        let selected = select_best_glob_match("docs/nested/readme.md", &candidates, |c| c.glob)
    ...
    fn equal_specificity_uses_candidate_order_as_tie_break() {
        ...
        let selected =
            select_best_glob_match("readme.md", &candidates, |c| c.glob).expect("should match");
