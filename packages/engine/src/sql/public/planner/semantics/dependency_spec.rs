...
fn dependency_spec_for_state_like_surface(binding: &SurfaceBinding) -> DependencySpec {
    ...
    if matches!(
        ...
        let version_scope = match binding.default_scope {
            ...
            | crate::sql::public::catalog::DefaultScopeSemantics::WorkingChanges => None,
        };
        if version_scope
...
fn canonical_state_scan(
    read_plan: &ReadPlan,
) -> Option<&crate::sql::public::planner::ir::CanonicalStateScan> {
    match read_plan {
...
fn canonical_change_scan(
    read_plan: &ReadPlan,
) -> Option<&crate::sql::public::planner::ir::CanonicalChangeScan> {
    match read_plan {
