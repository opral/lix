...
pub(crate) use public_surface::{
    ...
    build_public_write_invariant_trace, build_tracked_txn_unit,
    classify_public_execution_route_with_registry, finalize_public_write_execution,
    public_authoritative_write_error, public_surface_registry_mutations,
    public_write_preparation_error, semantic_plan_effects_from_domain_changes,
