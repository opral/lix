...
use crate::sql::logical_plan::{
    ...
    DirectoryHistorySortKey, FileHistoryAggregate, FileHistoryField, FileHistoryPredicate,
...
use sqlparser::ast::{
    BinaryOperator, Expr, FunctionArg, FunctionArgExpr, FunctionArguments, Ident, LimitClause,
    OrderByKind, Query, Select, SelectItem, SetExpr, Statement, Value as SqlValue,
};
...
fn direct_lowered_result_column_from_surface_type(
    ...
    match column_type {
        ...
        | crate::catalog::SurfaceColumnType::Json
        | crate::catalog::SurfaceColumnType::Variant => LoweredResultColumn::Untyped,
    }
}
        ...
        PublicReadPlanKind::HistoryRead => {
                ...
                .history_read_semantics(&structured_read.resolved_relation)
            {
                Some(CatalogHistoryReadSemantics::EntityHistoryActiveVersion) => {
                    return Ok(SpecializedPublicReadPreparation::Declined {
                        reason:
                            "entity-history direct history execution has been removed; expected sql2 lowering"
                                .to_string(),
