...
use crate::engine::sql::planning::rewrite_engine::escape_sql_string;
...
pub(crate) fn extract_explicit_transaction_script(
    ...
    let statements = crate::engine::sql::planning::rewrite_engine::parse_sql_statements(sql)?;
...
pub(crate) fn extract_explicit_transaction_script_from_statements(
    ...
    if middle.iter().any(|statement| {
        ...
        return Err(LixError { code: "LIX_ERROR_UNKNOWN".to_string(), description:
