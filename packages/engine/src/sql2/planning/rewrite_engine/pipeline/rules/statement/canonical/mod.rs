...
use crate::engine::sql2::planning::rewrite_engine::pipeline::query_engine::rewrite_read_query_with_backend_and_params;
use crate::engine::sql2::planning::rewrite_engine::steps::lix_state_history_view_write;
    ...
    for _ in 0..MAX_REWRITE_PASSES {
        match current {
            ...
            Statement::Query(query) => {
                let query = crate::engine::sql2::planning::rewrite_engine::pipeline::query_engine::rewrite_read_query(*query)?;
            ...
            Statement::Explain {
                ...
                let statement = match *statement {
                    Statement::Query(query) => Statement::Query(Box::new(
                        crate::engine::sql2::planning::rewrite_engine::pipeline::query_engine::rewrite_read_query(*query)?,
                    )),
                    other => other,
                };
                return Ok(StatementRuleOutcome::Emit(RewriteOutput {
