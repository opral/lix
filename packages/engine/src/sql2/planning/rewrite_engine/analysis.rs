...
use crate::engine::sql2::planning::rewrite_engine::{expr_references_column_name, ColumnReferenceOptions};
use crate::version::{
...
pub(crate) fn should_refresh_file_cache_for_sql(sql: &str) -> bool {
    let Ok(statements) = crate::engine::sql2::planning::rewrite_engine::parse_sql_statements(sql) else {
        return false;
    };
