...
pub async fn build_update_followup_sql(
    ...
    writer_key: Option<&str>,
    functions: &mut dyn LixFunctionProvider,
) -> Result<Vec<crate::engine::sql2::planning::rewrite_engine::types::PreparedStatement>, LixError> {
...
fn bind_statement_batch_for_dialect(
    ...
    for statement in batch.statements {
        ...
        prepared.push(crate::engine::sql2::planning::rewrite_engine::types::PreparedStatement {
            sql: bound.sql,
            params: bound.params,
        });
    }
