...
use crate::engine::sql2::history::commit_runtime::{
...
#[cfg(test)]
use crate::engine::sql2::history::commit_runtime::bind_statement_batch_for_dialect as bind_shared_statement_batch_for_dialect;
...
use crate::engine::sql2::planning::rewrite_engine::SchemaRegistration;
...
pub type DetectedFileDomainChange = crate::engine::sql2::contracts::effects::DetectedFileDomainChange;
...
fn bind_statement_batch_for_dialect(
    ...
    Vec<crate::engine::sql2::contracts::prepared_statement::PreparedStatement>,
    LixError,
> {
...
fn advance_placeholder_state_for_expr(
    ...
    impl Visitor for PlaceholderStateAdvancer<'_> {
        ...
        fn pre_visit_value(&mut self, value: &Value) -> std::ops::ControlFlow<Self::Break> {
            ...
            if let Err(error) =
                crate::engine::sql2::planning::rewrite_engine::params::resolve_placeholder_index(token, self.params_len, self.state)
            {
