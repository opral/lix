...
use crate::engine::sql2::planning::rewrite_engine::steps::{lix_version_view_read, vtable_read};
...
fn parse_insert_rows(
    ...
    rows: Vec<Vec<Expr>>,
    resolved_rows: Vec<Vec<crate::engine::sql2::planning::rewrite_engine::ResolvedCell>>,
    operation_name: &str,
...
fn field_required_string(
    index: Option<&usize>,
    resolved_row: &[crate::engine::sql2::planning::rewrite_engine::ResolvedCell],
    original_row: &[Expr],
    field: &str,
