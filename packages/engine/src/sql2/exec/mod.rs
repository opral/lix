...
pub(crate) fn append_path_value_replacement_value(
    ...
    bound_public_write::append_path_value_replacement_value(program, params, normalized)
}
...
pub(crate) fn append_path_value_replacement_value_text(
    ...
    bound_public_write::append_path_value_replacement_value_text(replacement_value, normalized)
}
