...
///
/// V63 binds the authenticated descriptor hierarchy plus content-addressed variant chunks and tracked HOT cut while
...
const REPOSITORY_PROTOCOL_VALUE: &[u8] = b"immutable-physical-commit-state.v63";
