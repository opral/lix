    ...
    P: LixFunctionProvider + Send + 'static,
{
    ...
    load_annotation_schema_from_json(schema_key, schema, functions).map(Some)
}
    ...
    P: LixFunctionProvider + Send + 'static,
{
    ...
    let annotations = load_annotation_schema_from_json(schema_key.clone(), schema, functions)?;
