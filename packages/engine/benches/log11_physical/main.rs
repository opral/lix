...
fn log11_physical_benches(c: &mut Criterion) {
    let runtime = tokio::runtime::Builder::new_current_thread()
        .enable_all()
        .build()
        .expect("create tokio runtime for log11 physical benchmarks");
    let rows = fixture_rows();

    for (label, row_count) in [("smoke", SMOKE_ROWS), ("scale", SCALE_ROWS)] {
        bench_raw_sqlite(c, &rows, row_count, label);
        bench_lix_physical(c, &runtime, &rows, row_count, label);
    }
}
...
fn bench_raw_sqlite(c: &mut Criterion, all_rows: &[PointerRow], row_count: usize, label: &str) {
    ...
    let mut group = c.benchmark_group(format!("log11_physical/raw_sqlite/{label}"));
...
fn bench_lix_physical(
    ...
    let change_rows = changed_row_count(row_count);
    let delta_chain_rows = (row_count / 100).max(1);

    for profile in [BackendProfile::Sqlite, BackendProfile::RocksDb] {
        let mut group = c.benchmark_group(format!("log11_physical/{}/{label}", profile.label()));
        configure_group(&mut group);
                ...
                b.iter_batched(
                    || {
                        runtime
                            ...
                            .expect("prepare log11 physical write root")
                    },
                    |fixture| {
                        ...
                        black_box(
                            runtime
                                ...
                                .expect("log11 physical write root"),
                        )
                    },
                    BatchSize::LargeInput,
                )
                    ...
                    |(backend, fixture)| {
                        black_box(
                            runtime
                                ...
                                .expect("log11 physical get_many"),
                        )
                    },
                    BatchSize::LargeInput,
                )
                    ...
                    |(backend, fixture)| {
                        black_box(
                            runtime
                                ...
                                .expect("log11 physical missing get_many"),
                        )
                    },
                    BatchSize::LargeInput,
                )
                    ...
                    |(backend, fixture)| {
                        black_box(
                            runtime
                                ...
                                .expect("log11 physical exists_many"),
                        )
                    },
                    BatchSize::LargeInput,
                )
                ...
                |(backend, fixture)| {
                    black_box(
                        runtime
                            ...
                            .expect("log11 physical scan keys"),
                    )
                },
                BatchSize::LargeInput,
            )
                    ...
                    |(backend, fixture)| {
                        black_box(
                            runtime
                                ...
                                .expect("log11 physical scan headers"),
                        )
                    },
                    BatchSize::LargeInput,
                )
                ...
                |(backend, fixture)| {
                    black_box(
                        runtime
                            ...
                            .expect("log11 physical scan full rows"),
                    )
                },
                BatchSize::LargeInput,
            )
                ...
                |(backend, fixture)| {
                    black_box(
                        runtime
                            ...
                            .expect("log11 physical prefix schema scan"),
                    )
                },
                BatchSize::LargeInput,
            )
                    ...
                    |(backend, fixture)| {
                        black_box(
                            runtime
                                ...
                                .expect("log11 physical prefix schema file null scan"),
                        )
                    },
                    BatchSize::LargeInput,
                )
                ...
                b.iter_batched(
                    || {
                        ...
                        let fixture = runtime
                            ...
                            .expect("prepare log11 physical delta update");
                        (backend, fixture)
                    },
                    |(backend, fixture)| {
                        black_box(
                            runtime
                                ...
                                .expect("log11 physical delta update"),
                        )
                    },
                    BatchSize::LargeInput,
                )
                ...
                b.iter_batched(
                    || {
                        ...
                        let fixture = runtime
                            ...
                            .expect("prepare log11 physical tombstones");
                        (backend, fixture)
                    },
                    |(backend, fixture)| {
                        black_box(
                            runtime
                                ...
                                .expect("log11 physical tombstones"),
                        )
                    },
                    BatchSize::LargeInput,
                )
                ...
                b.iter_batched(
                    || {
                        ...
                        let fixture = runtime
                            ...
                            .expect("prepare log11 physical changed keys");
                        (backend, fixture)
                    },
                    |(backend, fixture)| {
                        black_box(
                            runtime
                                ...
                                .expect("log11 physical changed keys"),
                        )
                    },
                    BatchSize::LargeInput,
                )
                ...
                b.iter_batched(
                    || {
                        ...
                        let fixture = runtime
                            ...
                            .expect("prepare log11 physical delta-chain changed keys");
                        (backend, fixture)
                    },
                    |(backend, fixture)| {
                        black_box(
                            runtime
                                ...
                                .expect("log11 physical delta-chain changed keys"),
                        )
                    },
                    BatchSize::LargeInput,
                )
                ...
                b.iter_batched(
                    || {
                        ...
                        let fixture = runtime
                            ...
                            .expect("prepare log11 physical materialize delta chain");
                        (backend, fixture)
                    },
                    |(backend, fixture)| {
                        black_box(
                            runtime
                                ...
                                .expect("log11 physical materialize delta chain"),
                        )
                    },
                    BatchSize::LargeInput,
                )
...
fn prepare_raw_sqlite_empty() -> RawSqliteFixture {
    ...
    let conn =
        Connection::open(dir.path().join("log11-physical.sqlite")).expect("open raw sqlite db");
    conn.execute_batch(
        "
    ...
    .expect("configure raw sqlite db");
...
fn prepare_physical_read(
    ...
    let fixture = runtime
        ...
        .expect("prepare log11 physical read");
    (backend, fixture)
}
...
criterion_group!(benches, log11_physical_benches);
