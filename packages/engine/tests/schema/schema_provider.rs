    ...
    |sim| async move {
        ...
        let result = engine
            .execute(
             ...
             lix_json('{\"x-lix-key\":\"same_request_schema\",\"x-lix-version\":\"1\",\"x-lix-primary-key\":[\"/id\"],\"type\":\"object\",\"properties\":{\"id\":{\"type\":\"string\"},\"name\":{\"type\":\"string\"}},\"required\":[\"id\",\"name\"],\"additionalProperties\":false}'),\
             'global'\
             ); \
...
simulation_test!(
    ...
    |sim| async move {
        ...
        .execute(
            "INSERT INTO lix_registered_schema_by_version (value, lixcol_version_id) VALUES (\
             lix_json('{\"x-lix-key\":\"same_request_default_schema\",\"x-lix-version\":\"1\",\"x-lix-primary-key\":[\"/id\"],\"type\":\"object\",\"properties\":{\"id\":{\"type\":\"string\"},\"name\":{\"type\":\"string\"},\"slug\":{\"type\":\"string\",\"x-lix-default\":\"name + ''-slug''\"}},\"required\":[\"id\",\"name\"],\"additionalProperties\":false}'),\
             'global'\
             ); \
