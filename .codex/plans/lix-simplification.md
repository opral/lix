...
#1747 and #1746 passed full CI and merged into integration. The final merge of main `7d9a1e7c2` preserves #1749 commit spans through shared idempotency recovery, typed staging and reconciled-parent receipts. Removed TypeScript helper files remain retired; malformed-span coverage now lives in the active Rust decoder. Final local validation: 3,744 all-feature engine tests passed (72 skipped), 10 doctests, strict all-target/all-feature Clippy, and both decoder span tests passed.
