...
mod cold_scan_tests {
    use super::{
        ChangeEffect, ColdInitialImport, CsvRow, Dialect, Document, IdNamespace, ROOT_ROW_PK,
        ROW_SCHEMA_KEY, RowChange, RowLayout, RowRecord, TABLE_SCHEMA_KEY, TypedValue,
