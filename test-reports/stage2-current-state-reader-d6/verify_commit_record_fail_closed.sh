...
repo=${1:?usage: verify_commit_record_fail_closed.sh <immutable-worktree>}
...
# This is deliberately a negative control.  The immutable 1f742 source must
# be rejected until every CommitCatalog-enumerated CommitRecord is required,
# identity-checked, and errors before any partial row can be returned.
