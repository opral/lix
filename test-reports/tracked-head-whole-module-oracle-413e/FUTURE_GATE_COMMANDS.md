...
No adapter build or runtime is run for the 413e calibration. Once a runnable
...
export ORACLE="$CANDIDATE_ROOT/test-reports/tracked-head-whole-module-oracle-413e"
...
CARGO_TARGET_DIR="$EVIDENCE/target-memory" \
  cargo test -p engine-benchmarks --test tracked_head_whole_module_oracle -- \
