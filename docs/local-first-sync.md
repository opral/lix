...
| --- | ---: | ---: | ---: | ---: |
| Current point read | 0.91 ms | 1.00 ms | 0.86 ms | 0.82 ms |
| Current write | 313.80 ms | 1.43 ms | 353.82 ms | 1.30 ms |
| Partial checkpoint | 333.09 ms | 2.57 ms | 391.13 ms | 2.35 ms |
| Folder move | 329.79 ms | 2.57 ms | 405.84 ms | 4.39 ms |
| Full checkpoint | 332.05 ms | 1.16 ms | 390.21 ms | 1.06 ms |
...
allocation fell from 248.55 MB to 1.40 MB. Folder-move allocation still grows
with the filesystem working set (3.26 MB at 32 rows, 7.56 MB at 256 rows), so
