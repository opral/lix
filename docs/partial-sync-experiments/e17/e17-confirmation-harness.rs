...
async fn run(case: Case, snapshot: &[u8], sample: usize, rtt: u64) {
    ...
    for iteration in 0..repeats {
        ...
        warm_samples.push(json!({"iteration":iteration,"us":elapsed_us,"network":network}));
    }
