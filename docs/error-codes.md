...
| `LIX_AUTHORITY_EXECUTION_REQUIRED` | [packages/lix/src/sync/mod.rs](../packages/lix/src/sync/mod.rs) |
| `LIX_AUTHORITY_UNTRACKED_UNSUPPORTED` | [packages/lix/src/engine.rs](../packages/lix/src/engine.rs) |
...
| `LIX_DIFF_HOT_UNAVAILABLE` | [packages/lix/src/handle.rs](../packages/lix/src/handle.rs) |
...
| `LIX_ERROR_MIGRATION_LIMIT_EXCEEDED` | [packages/lix/src/migration/api.rs](../packages/lix/src/migration/api.rs) |
...
| `LIX_INVALID_ACCOUNT_ID` | [packages/lix/src/engine.rs](../packages/lix/src/engine.rs) |
...
| `LIX_NOT_FOUND` | [packages/server/src/routes.rs](../packages/server/src/routes.rs) |
...
| `LIX_STORAGE_IN_USE` | [packages/js-sdk/src/open-lix.ts](../packages/js-sdk/src/open-lix.ts) |
